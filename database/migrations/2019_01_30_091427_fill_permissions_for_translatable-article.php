...
class FillPermissionsForTranslatableArticle extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTranslatableArticle constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.translatable-article',
            'admin.translatable-article.index',
            'admin.translatable-article.create',
            'admin.translatable-article.show',
            'admin.translatable-article.edit',
            'admin.translatable-article.delete',
        ]);
