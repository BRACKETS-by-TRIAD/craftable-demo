...
class FillPermissionsForBulkAction extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBulkAction constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.bulk-action',
            'admin.bulk-action.index',
            'admin.bulk-action.create',
            'admin.bulk-action.show',
            'admin.bulk-action.edit',
            'admin.bulk-action.delete',
        ]);
